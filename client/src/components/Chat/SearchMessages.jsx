...
const [searchedMessages, setSearchedMessages] = useState([]);
  ...
  return <div className="border-conversation-border border-l w-full bg-conversation-panel-background flex flex-col z-10 max-h-screen">
    <div className="h-16 px-4 py-5 gap-10 items-center bg-panel-header-background text-primary-strong">
      ...
      <div className="flex items-center flex-col w-full ">
        <div className=" flex px-5 items-center gap-3 h-14 w-full">
          <div className=" bg-panel-header-background flex items-center gap-5 px-3 py-1 rounded-lg flex-grow">
            ...
            <div>
              <input type="text" placeholder="Search messages" value={searchTerm} className=" bg-transparent text-sm focus:outline-none text-white w-full"
